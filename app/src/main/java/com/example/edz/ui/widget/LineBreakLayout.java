...
//     * 所有标签
//     */
//    private List<LabelResponse.ResponseBean> lables;
//    /**
//     * 选中标签
//     */
//    private List<LabelResponse.ResponseBean> lableSelected = new ArrayList<>();
//
//    //自定义属性
...
//
//    public void setItemListener(BaseFragmentListener listener) {
...
//     * @param add    是否追加
//     */
//    public void setLables(List<LabelResponse.ResponseBean> lables, boolean add) {
//        if (this.lables == null) {
...
//            for (final LabelResponse.ResponseBean lable : lables) {
//                //获取标签布局
//                final TextView tv = (TextView) inflater.inflate(R.layout.label_item, null);
...
//     * 获取选中标签
//     */
//    public List<LabelResponse.ResponseBean> getSelectedLables() {
